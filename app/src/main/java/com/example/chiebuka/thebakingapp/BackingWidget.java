...
import com.example.chiebuka.thebakingapp.widget.BakingService;
import com.example.chiebuka.thebakingapp.widget.WidgetDataProvider;
...
public class BackingWidget extends AppWidgetProvider {
    ...
    public static final String WIDGET_IM_PREV ="AppWidget_imPrev";
     ...
     void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
       ...
       RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.bakig_widget);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(action.equals(BackingWidget.WIDGET_IM_NEXT)){

            Log.v("Harry", "dataset changed4  ");
            AppWidgetManager mgr = AppWidgetManager.getInstance(context);
            ComponentName cn = new ComponentName(context, BackingWidget.class);
